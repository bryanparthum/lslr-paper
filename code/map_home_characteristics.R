...
## arrange in grid
legend = get_legend(college + 
                      theme(legend.margin = margin(l = 2, r = 0, b = 2, t = 0, unit = 'cm')))

college   = college + theme(legend.position = "none")
owner     = owner + theme(legend.position = "none")
homevalue = homevalue + theme(legend.position = "none")
...
ggarrange(college, 
          ...
          ncol = 2,
          common.legend = F,
          labels = c('Share of Adults with College Degree',
                     'Share of Homes Owner-Occupied',
                     'Percentile of Assessed Home Value'),
          font.label = list(family = "sans-serif", color = 'grey20'),
          hjust = 0)

## export
ggsave('figures/map_home_characteristics.svg', width = 10, height = 10)
